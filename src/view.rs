...
impl View {
    ...
    pub fn show_footer_helper(app: &mut App, f: &mut Frame, area: Rect) {
        let help_string = match app.view_mode {
            ViewMode::ViewProjects => {
                "<Up/Down> next/prev - <Enter/Right> go to tasks - <n> new - <r> rename - <d> delete"
            }
            ...
            ViewMode::ViewTasks => {
                "<Up/Down> next/prev - <Esc/Left> go to projects - <Enter> change status - <n> new - <r> rename - <d> delete"
            }
